...
class QuizAngka : AppCompatActivity() {
    ...
    private val soalList = listOf(
        Soal("Yang manakah angka 'Sepuluh' itu??", "10", listOf("1", "5", "10")),
        Soal("Yang manakah angka 'Satu' itu??", "1", listOf("5", "9", "1")),
        Soal("Yang manakah angka 'Lima' itu??", "5", listOf("5", "4", "2"))
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.quiz_angka1)

        soalText = findViewById(R.id.tvPertanyaan)
        pilihan1 = findViewById(R.id.pilihan1angka)
        pilihan2 = findViewById(R.id.pilihan2angka)
        pilihan3 = findViewById(R.id.pilihan3angka)
        buttonBack = findViewById(R.id.back_quizangka)
        buttonNext = findViewById(R.id.next_quizangka)
        progressBar = findViewById(R.id.progress_quizangka1)
